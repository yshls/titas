...
- **실시간 대본 편집**: 생성된 대본을 언제든지 수정할 수 있으며, 대사 라인을 추가하거나 삭제하며 대본을 완성할 수 있습니다.
...
- **연습 제어**: 힌트 보기, 재시도, 중단 및 저장 등 유연한 학습 제어 기능을 제공합니다.

### 3. 학습 성과 분석 (Progress Analysis)

- **학습 대시보드**:
  - **캘린더**: 날짜별 연습 기록을 캘린더 형태로 제공합니다.
  - **핵심 지표**: 평균 정확도, 누적 대본 수 등 성과 지표를 시각화합니다.
- **약점 분석 (Weak Spots)**:
  - **오답 노트**: 전체 연습 데이터를 분석하여 가장 많이 틀린 단어 Top 10을 추출합니다.
  - **발음 청취**: 취약한 단어의 정확한 발음을 즉시 들어보고 교정할 수 있습니다.
